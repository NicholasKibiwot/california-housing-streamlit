...
if model is None:
    ...
    st.info("""
        ### How to Fix This:
        1. Download the model file from your Kaggle notebook
        2. Add `california_knn_pipeline.pkl` to the GitHub repository
        3. Commit and push the changes
        4. The app will automatically reload with the model
    """)
    st.stop()
