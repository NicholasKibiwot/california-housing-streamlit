...
# Version 2.1 - Fixed Streamlit Cloud file loading
# Page Configuration
st.set_page_config(
...
def load_model():
 ...
 possible_paths = [
 'california_knn_pipeline.pkl',  # Root directory
 Path(__file__).parent / 'california_knn_pipeline.pkl',  # Same directory as script
 Path.cwd() / 'california_knn_pipeline.pkl',  # Current working directory
 ]
 ...
 # If file not found locally, try downloading from GitHub
 import requests
 try:
 github_raw_url = "https://raw.githubusercontent.com/NicholasKibiwot/california-housing-streamlit/main/california_knn_pipeline.pkl"
